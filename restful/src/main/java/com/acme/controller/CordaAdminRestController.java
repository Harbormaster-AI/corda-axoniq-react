...
public class CordaAdminRestController extends BaseCordaSpringRestController {
	...
	public Map< String, net.corda.core.concurrent.CordaFuture> bulkCreateTokens( @RequestBody(required=true) Automobile app, @RequestParam(required=true) PartyEnum partyEnum ) {
		...
		if ( proxy != null ) {
			...
			futureMap.put( "Chassis Token", proxy.startFlowDynamic( CreateChassisToken.class, app.chassisId ).getReturnValue() );

            LOGGER.info( "Starting a flow for CreateNewBody" );
			futureMap.put( "Body Token", proxy.startFlowDynamic( CreateBodyToken.class, app.bodyId ).getReturnValue() );

            LOGGER.info( "Starting a flow for CreateNewEngine" );
			futureMap.put( "Engine Token", proxy.startFlowDynamic( CreateEngineToken.class, app.engineId ).getReturnValue() );

            LOGGER.info( "Starting a flow for CreateNewTransmission" );
			futureMap.put( "Transmission Token", proxy.startFlowDynamic( CreateTransmissionToken.class, app.transmissionId ).getReturnValue() );

            LOGGER.info( "Starting a flow for CreateNewBraking" );
			futureMap.put( "Braking Token", proxy.startFlowDynamic( CreateBrakingToken.class, app.brakingId ).getReturnValue() );

            LOGGER.info( "Starting a flow for Interior" );
			futureMap.put( "Interior Token", proxy.startFlowDynamic( CreateInteriorToken.class, app.interiorId ).getReturnValue() );
	...
	public net.corda.core.concurrent.CordaFuture bulkDestroyTokens( @RequestBody(required=true) Automobile app, @RequestParam(required=true) PartyEnum partyEnum) {
    ...
    public net.corda.core.concurrent.CordaFuture bulkTransferTokens( @RequestBody(required=true) Automobile app, @RequestParam(required=true) PartyEnum partyEnum) {
		net.corda.core.messaging.CordaRPCOps proxy = proxy( partyEnum );
		net.corda.core.concurrent.CordaFuture future = null;
		boolean exactMatch = true;
     ...
     */
	@PutMapping("/issueNew")
    public net.corda.core.concurrent.CordaFuture issueNewAutomobile( @RequestBody(required=true) Automobile app, @RequestParam(required=true) PartyEnum partyEnum ) {
    ...
    public net.corda.core.concurrent.CordaFuture transferAutomobileToken(@RequestBody(required=true) Automobile app, @RequestParam(required=true) PartyEnum partyEnum ) {
