    ...
    render() {
        return (
            <div>
                ...
                <p/>
                    <button className="btn btn-primary btn-sm" onClick={this.flows}> Flows</button>
                    &nbsp;<button className="btn btn-primary btn-sm" onClick={this.networkParameters}>  Network Identities</button>
                    &nbsp;<button className="btn btn-primary btn-sm" onClick={this.notaryIdentities}>  Notary Identities</button>
                    &nbsp;<button className="btn btn-primary btn-sm" onClick={this.nodeInfo}>  Node Info</button>
                    &nbsp;<button className="btn btn-primary btn-sm" onClick={this.nodeDiagnosticInfo}>  Node Diagnostic Info</button>
                    &nbsp;<button className="btn btn-primary btn-sm" onClick={this.vaultQuery}>  Vault Query </button>
                <p/>
                <h6> Results </h6>
